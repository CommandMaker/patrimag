...
const displayFlash = (type, message) => {
    ...
    const flashButton = document.createElement('div');
    flashButton.classList.add('close-container');
    flashButton.innerHTML = `
    <div class="close-container">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="flash-close-button" width="80"
            height="80">
    ...
    flashText.classList.add('flash-message');
    flashText.innerText = message;

    flash.appendChild(flashButton);
    flash.appendChild(flashText);

    document.querySelector('.flashes-container').appendChild(flash);
}
