...
@section('body')
    <div class="container">
        ...
        <form action="{{ route('admin.article.edit', ['id' => $article->id]) }}" id="edit-article-form" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="field">
                ...
                <div class="control">
                    <input type="text" class="input" id="title" name="title" value="{{ $article->title }}" placeholder="Titre de l'article">
                </div>
                @error('title')
            ...
            <div class="field">
                ...
                <div class="textarea-control">
                    <textarea type="text" class="input" id="description" name="description" placeholder="Description de l'article">{{ $article->description }}</textarea>
                </div>
                @error('description')
                    <p class="help-text is-danger">{{ $message }}</p>
                @enderror
            ...
            <div class="field">
                ...
                <textarea name="content" id="admin-content">{{ $article->content }}</textarea>
                @error('content')
                        <p class="help-text is-danger">{{ $message }}</p>
                @enderror
            </div>
